...
public class MainFormController implements Initializable 
{
    ...
    public void initialize(URL url, ResourceBundle rb) 
    {
        ...
        Student st1 = new Student("Igor", "Verkin", "1994-09-08", "Computer science", "PZKS", "Second","243", "2015-03-02");
        Student st2 = new Student("Zaplitniy", "Andrew", "1996-12-10", "Computer science", "PZKS", "Second","243", "2016-04-15");
        Student st3 = new Student("Baranuk", "Eugene", "1995-06-22", "Computer science", "PZKS", "Second","243", "2015-02-10");
        Student st4 = new Student("Alexander", "Bezverhniy", "1995-02-04", "Computer science", "PZKS", "Second","243", "2015-02-29");
